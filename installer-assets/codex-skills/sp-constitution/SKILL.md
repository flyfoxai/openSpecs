...
description: Run the document-stage `sp.constitution` step. Trigger with `$sp-constitution`.
---

# sp-constitution

Use this skill when the user wants to establish or refresh the project constitution for the `sp` workflow.
