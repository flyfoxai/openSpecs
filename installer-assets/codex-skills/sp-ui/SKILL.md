---
name: sp-ui
description: Run the document-stage `sp.ui` step. Trigger with `$sp-ui`.
---

# sp-ui

Use this skill when the user wants to define or refresh the screen structure and UI interaction documents for the active feature.
