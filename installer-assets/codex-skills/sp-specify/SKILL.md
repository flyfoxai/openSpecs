---
name: sp-specify
description: Run the document-stage `sp.specify` step. Trigger with `$sp-specify`.
---

# sp-specify

Use this skill when the user wants to create or refresh the baseline requirement document for the active feature.
