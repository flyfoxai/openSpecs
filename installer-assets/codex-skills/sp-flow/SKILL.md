---
name: sp-flow
description: Run the document-stage `sp.flow` step. Trigger with `$sp-flow`.
---

# sp-flow

Use this skill when the user wants to define or refresh the business flow documents for the active feature.
