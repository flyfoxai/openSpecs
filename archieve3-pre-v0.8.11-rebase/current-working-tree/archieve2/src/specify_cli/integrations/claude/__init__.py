...
from ...naming import canonical_skill_name, strip_skill_prefix
...
ARGUMENT_HINTS: dict[str, str] = {
    ...
    "bundle": "Optional packaging or release constraints",
    "clarify": "Optional areas to clarify in the spec",
    "constitution": "Principles or values for the project constitution",
    "checklist": "Domain or focus area for the checklist",
    "flow": "Optional workflow or journey to focus on",
    "gate": "Optional gate focus or readiness concerns",
    "taskstoissues": "Optional filter or label for GitHub issues",
    "ui": "Optional screen, component, or interaction focus",
}
...
class ClaudeIntegration(SkillsIntegration):
    ...
    def _render_skill(self, template_name: str, frontmatter: dict[str, Any], body: str) -> str:
        ...
        skill_name = canonical_skill_name(template_name)
    ...
    def setup(
        ...
        **opts: Any,
        ...
        for path in created:
            ...
            stem = strip_skill_prefix(skill_dir_name)
