...
from ..naming import canonical_command_filename, canonical_skill_name
    ...
    * ``context_file``     — path (relative to project root) of the agent
    ...
    def command_filename(self, template_name: str) -> str:
        ...
        *template_name* is the stem of the source file (e.g. ``"plan"``).
        ...
        """
        return canonical_command_filename(template_name)
...
class TomlIntegration(IntegrationBase):
    ...
    def command_filename(self, template_name: str) -> str:
        ...
        return canonical_command_filename(template_name, ".toml")
    ...
    def setup(
        ...
        **opts: Any,
        ...
        for src_file in templates:
            ...
            skill_name = canonical_skill_name(command_name)
