...
class TestForgeCommandNameFormatter:
    ...
    def test_simple_name_without_prefix(self):
        """Test formatting a simple name without a namespace prefix."""
    ...
    def test_name_with_speckit_prefix(self):
        """Test formatting a name that already has a known namespace prefix."""
        assert format_forge_command_name("sp.plan") == "sp-plan"
    ...
    def test_extension_command_name(self):
        ...
        assert format_forge_command_name("sp.my-extension.example") == "sp-my-extension-example"
        assert format_forge_command_name("my-extension.example") == "sp-my-extension-example"

    def test_complex_nested_name(self):
        """Test formatting deeply nested command names."""
        assert format_forge_command_name("sp.jira.sync-status") == "sp-jira-sync-status"
        assert format_forge_command_name("speckit.foo.bar.baz") == "sp-foo-bar-baz"

    def test_name_with_hyphens_preserved(self):
        """Test that existing hyphens are preserved."""
        assert format_forge_command_name("my-extension") == "sp-my-extension"
        assert format_forge_command_name("speckit.my-ext.test-cmd") == "sp-my-ext-test-cmd"

    def test_alias_formatting(self):
        """Test formatting alias names."""
        assert format_forge_command_name("sp.my-extension.example-short") == "sp-my-extension-example-short"
...
class TestForgeCommandRegistrar:
    ...
    def test_registrar_formats_extension_command_names_for_forge(self, tmp_path):
        ...
        assert "sp.my-extension.example" in registered
        
        # Check the generated file has hyphenated name in frontmatter
        forge_cmd = tmp_path / ".forge" / "commands" / "sp.my-extension.example.md"
        ...
        assert frontmatter["name"] == "sp-my-extension-example"
    ...
    def test_registrar_formats_alias_names_for_forge(self, tmp_path):
        ...
        alias_file = tmp_path / ".forge" / "commands" / "sp.my-extension.ex.md"
        ...
        assert frontmatter["name"] == "sp-my-extension-ex"
    ...
    def test_registrar_does_not_affect_other_agents(self, tmp_path):
        ...
        windsurf_cmd = tmp_path / ".windsurf" / "workflows" / "sp.my-extension.example.md"
