...
4. Refresh routing and memory artifacts to keep later commands discoverable.
   - Use `.specify/templates/feature/` as the structural template root for new feature artifacts.
   - Preserve template table headers, routing fields, ID prefixes, and placeholder semantics when refreshing files.
...
- Suggest `__SPECKIT_COMMAND_CLARIFY__`.
