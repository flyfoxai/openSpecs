...
- Use `.specify/templates/feature/bundle.md` and `.specify/templates/feature/memory/trace-index.md` as structural references when creating or repairing bundle and trace artifacts.
...
- Suggest `__SPECKIT_COMMAND_PLAN__`.
