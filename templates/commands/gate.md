...
- Use `.specify/templates/feature/gate.md` as the structural reference when creating or repairing the gate decision.
...
- If PASS, suggest `__SPECKIT_COMMAND_BUNDLE__`.
